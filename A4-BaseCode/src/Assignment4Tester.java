public class Assignment4Tester {
    public static void main(String[] args){
        ...
        Customer c1 = new Customer("Frodo"); //1
        Customer c2 = new Customer("Galadriel");//2
        Customer c3 = new Customer("Tom B.");//3

        store.registerCustomer(c1);
        store.registerCustomer(c2);
        store.registerCustomer(new Customer("Eowyn"));//4
        store.registerCustomer(c3);
        store.registerCustomer(new Customer("Shadowfax"));//5
        store.registerCustomer(new Customer("Galadriel"));
        store.registerCustomer(new Customer("Lobelia"));//6
        store.registerCustomer(new Customer("Bert"));//7
        store.registerCustomer(new Customer("Shadowfax"));
        store.registerCustomer(new Customer("William"));//8
